import { TGE1 as INK } from "constants/tokenAddresses";
...
export async function addInkToWallet() {
  await addTokenToWallet("INK", INK, "ink_black_alpha.png");
}
    ...
    const wasAdded = await window.ethereum.request({
      ...
      params: {
        ...
        options: {
          ...
          image: window.location.protocol + "//" + window.location.host + "/" + tokenIconUrl,
        },
      },
    });
