    ...
    >
      <Grid container spacing={1}>
        ...
        <Grid item xs={3} sx={{ display: manageFarm === true ? "" : "none" }}>
          <StyledItem>
            <Typography sx={{ marginTop: "5px" }} variant="h4">Manage Liquidity</Typography>
            <Typography sx={{ margin: "20px" }} variant="body1">Use this to stake, unstake or withdraw all of your LP tokens and rewards from the yield farm</Typography>
          </StyledItem>
        </Grid>
